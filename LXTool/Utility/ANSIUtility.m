...
//    NSAttributedString *timeStr = [[NSAttributedString alloc]initWithString:[NSString stringWithFormat:@"%@ ",[NSDate date]]];
//    NSMutableAttributedString *result = [[NSMutableAttributedString alloc]initWithString:[NSString stringWithFormat:@"%@ ",[NSDate date]]];
//    [result insertAttributedString:attributedResult atIndex:timeStr.length];
